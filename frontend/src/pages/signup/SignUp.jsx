        ...
        <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
            ...
            backdrop-blur-lg bg-opacity-0">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Link to={"/login"} className="text-sm hover:underline hover:text-orange-600 mt-2 inline-block" href="#">
...
//                     </div>
//                     <GenderCheckbox />
//                     <a className="text-sm hover:underline hover:text-orange-600 mt-2 inline-block" href="#">
//                         Already have an account?
//                     </a>
//                     <div>
